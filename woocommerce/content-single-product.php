                        ...
                        <div class="cartinformation row justify-content-between align-items-start">
                            ...
                            <div class="col-6">
                                <div class="add-quantity-section justify-content-start">
                                    <button type="submit" id="add-to-cart-" class="single_add_to_cart_button button alt<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>">
